  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      <svg width={size} height={size} viewBox="0 0 40 40" fill="none" style={{ flexShrink: 0 }}>
        ...
        <defs><linearGradient id="ag" x1="0" y1="0" x2="40" y2="40"><stop stopColor="#6C3FC5"/><stop offset="1" stopColor="#4e2d9a"/></linearGradient></defs>
      ...
      {!collapsed && (
        <div style={{ lineHeight: 1.2 }}>
          ...
          <div style={{ fontFamily: 'Plus Jakarta Sans,sans-serif', fontSize: '.6rem', color: 'rgba(255,255,255,.5)', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '.06em' }}>Admin</div>
        </div>
      )}
    </div>
  )
